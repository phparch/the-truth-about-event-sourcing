...
use App\Models\ContactEventSauce;
use EventSauce\EventSourcing\Message;
use EventSauce\EventSourcing\MessageConsumer;

class ContactConsumer implements MessageConsumer
{
    ...
    {
        ContactEventSauce::factory()->create([
    ...
    {
        $contact = ContactEventSauce::find($message->aggregateRootId()->toString());
