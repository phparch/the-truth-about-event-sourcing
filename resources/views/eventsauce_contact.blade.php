<x-app-layout>
    <div>
        ...
        <div class="border-2 border-amber-500 rounded-2xl p-4 m-4 bg-gray-50 shadow-2xl text-lg w-1/2 mx-auto">
            <div>
                <form action="{{ route('contact.eventsauce.store', $contact->aggregateRootId()->toString())}}"
                      method="post">
                    @csrf
                    <div class="m-2">
            ...
            <div
                ...
                @foreach($events as $event)
                    <div
                        class="p-6 m-4 justify-between border border-purple-400 bg-purple-200 rounded-2xl">
                        @php dump($event); @endphp
                    </div>
